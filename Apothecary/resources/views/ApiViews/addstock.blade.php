...
<div class="container">
    ...
    <div class="jumbotron">
   <h1>Add New  Stock Form</h1>
    <a href="/viewstock" class="btn btn-primary" >View Stocks </a>
    <form action="/addstockdata" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <textarea name="Item_Detailed_Description" cols="80" rows="40" value="{{ htmlspecialchars($stock->Item_Detailed_Description) }}" placeholder="Enter Item Detailed Description" 
