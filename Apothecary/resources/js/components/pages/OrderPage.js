...
import {MDBTable, MDBTableHead, MDBTableBody,MDBBtn,MDBIcon,MDBModal,MDBModalBody,MDBModalHeader,MDBRow,MDBCol } from 'mdbreact';
import Card from 'react-bootstrap/Card'
import { Table,FormText } from 'reactstrap';
...
export default class OrderPage extends Component {
  ...
  return (
    <>       {this.state.loading ? <div>       
            ...
            <MDBRow>
            <MDBCol md='6'>
            <h3>Orders<h6>(Click on a row to view further details)</h6></h3></MDBCol><MDBCol md='6'>
            <div id='slct' className='mt-4'><h5 id='slctset'>Select the type of Orders to list: </h5> &ensp;<h4>
            ...
            </h4><Card border='info' id='slc' onClick={this.onSbmt} style={{ cursor: 'pointer' }}><MDBIcon icon="check" size='2x' className='cyan-text'/></Card></div></MDBCol></MDBRow>                
