...
export default class ChartSection1 extends Component {
    ...
    componentDidMount () {
        ...
        axios.get(`/api/weeksSale/${this.state.pharm_id}`).then(response => {
         ...
         axios.get(`/api/weeksPurchase/${this.state.pharm_id}`).then(response => {
            
            response.data.map(purchases => (
                temp1 = temp1+parseInt(purchases.Payed_Amount)
                ))
         ...
         axios.get(`/api/weeksOrder/${this.state.pharm_id}`).then(response => {
            
            this.setState({
                weeksOrder: response.data
            })
        ...
        return (
            ...
            <MDBRow className="mb-4">
                <MDBCol md="8"className="mb-4">
                    ...
                    <MDBCardHeader>Annual Order Data</MDBCardHeader>
                        <MDBCardBody>
