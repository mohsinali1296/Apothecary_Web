...
import {MDBModal,MDBIcon, MDBModalBody, MDBModalHeader,MDBRow} from 'mdbreact';
          ...
          <div id='container1'>
            {this.state.loading ? <div>    
             <MDBModal toggle={this.toggle(1)} isOpen={this.state.modal1} >
                                ...
                                <input type='number' min="0" id='total' name='discount' value={this.state.discount} onChange={this.handleFieldChange} /><b>Rs.</b>
                                <br></br>
                                ...
                                <input type='number' min="0" id='total' name='paid' value={this.state.paid} onChange={this.handleFieldChange} /><b>Rs.</b>
                                <br></br>
                                ...
                                <MDBRow id='ml-50'><label id='Lfont1'><b>Distributor:&nbsp;</b></label>
                                <Select
                                    name="distributor"
                                ...
                                <input type='date' name='date' value={this.state.date} onChange={this.handleFieldChange} />
                                <br></br><br></br>
                ...
                <div className='row justify-content-center'>
                  <div className='col-md-11'>
                    ...
                    <div className='card-header' id='col'><div className=' d-flex justify-content-between align-items-center'>
                      <MDBIcon  icon='arrow-left' size='2x' style={{ cursor: 'pointer' }} onClick={() => this.props.history.goBack()}/><div><h5>PurchaseEntry - Apothecary</h5></div><MDBIcon icon='cart-plus' size='2x'/></div></div>
                          ...
                          <Card><form>
                             ...
                             <Card border='light'><Form id='prodDeets'>
                                ...
                                <Input type='text' id='prodDeet1' onBlur={(e) => e.target.placeholder = 'Please enter a numberic value >0'} onFocus={(e) => e.target.placeholder = ""} placeholder='Please enter a numberic value >0' name='buy_price' value={this.state.buy_price} onChange={this.handleFieldChange} />
                             </Form></Card> <br></br>
