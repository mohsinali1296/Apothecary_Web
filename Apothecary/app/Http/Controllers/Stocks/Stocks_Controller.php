...
public function update(Request $request){
    ...
    $stock = Stocks_Model::find($request->Id); 
                $stock->Name=$request->Name;
                    $stock->Item_Description=$request->Item_Description;
                    $stock->Item_Detailed_Description=$request->Item_Detailed_Description;
                    $stock->Formula=$request->Formula;
                    $stock->Pharm_Id=$request->Pharm_Id;
                    $stock->Category_Id=$request->Category_Id;
                    $stock->sub_category=$request->sub_category;
                    $stock->unit_Qty=$request->unit_Qty;
                    $stock->qty_per_leaf=$request->qty_per_leaf;
                    $stock->qty_per_box=$request->qty_per_box;
                    $stock->unit_price=$request->unit_price;
                    $stock->leaf_price=$request->leaf_price;
                    $stock->box_price=$request->box_price;
                    $stock->DOE=$request->DOE;
                    $stock->Brand=$request->Brand;
                    $stock->prescription_required=$request->prescription_required;
